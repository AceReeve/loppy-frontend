...
import { RemoveOpportunitySchema } from "@/src/schemas";

export default function RemoveOpportunity(prop: CustomTriggerProps) {
  const formSchema = RemoveOpportunitySchema;
  ...
  const createUpdateOpportunityNode = {
    ...
    data: {
      ...
      node_name: "Remove Opportunity",
      node_type_id: "Remove Opportunity",
