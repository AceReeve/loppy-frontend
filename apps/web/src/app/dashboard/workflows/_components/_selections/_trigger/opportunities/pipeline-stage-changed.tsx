...
export default function PipelineStageChanged(prop: CustomTriggerProps) {
  ...
  const opportunityStatusChangedNode = {
    ...
    data: {
      title: form.getValues("title"),
      node_name: "Pipeline Stage Changed",
      node_type_id: "Pipeline Stage Changed",
      content: {
        filters: form.getValues("filters"),
      },
    },
