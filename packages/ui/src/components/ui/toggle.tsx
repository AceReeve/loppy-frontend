...
const toggleVariants = cva(
  "inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-white transition-colors  " +
    ...
    "data-[state=on]:bg-primary data-[state=on]:text-white dark:ring-offset-gray-950 data-[state=on]:disabled " +
...

  {
    variants: {
      variant: {
        ...
        outline:
          "border border-gray-200 bg-transparent hover:bg-gray-100 hover:text-gray-900 dark:border-gray-800 dark:hover:bg-gray-800 dark:hover:text-gray-50 rounded-xl",
        rounded:
