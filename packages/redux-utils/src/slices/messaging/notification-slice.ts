...
export const notificationSlice = createSlice({
    ...
    initialState ,
    reducers: {
        addNotifications : (state: NotificationsType,action: PayloadAction<NotificationsType>) => {
            state.push(...action.payload);
        },
        removeNotifications : (state:NotificationsType, action: PayloadAction<number>) =>{
